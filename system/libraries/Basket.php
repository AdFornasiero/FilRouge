...
class CI_Basket {
    ...
    public function __construct(){
        $this->load_config(CI_Basket::BASKET, [CI_Basket::CONFIG_ID_KEY]);
    ...
    protected function update_basket_array(array $updated_basket) : void {
        $this->session->set_userdata(CI_Basket::BASKET, $updated_basket);
    }
    ...
    protected function set_session() : void {
        if ($this->session->userdata(CI_Basket::BASKET) == null || ! is_array($this->session->userdata(Basket::BASKET))) {
